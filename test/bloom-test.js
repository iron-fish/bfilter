...
describe('bfilter', function() {
  ...
  it('should serialize to the correct format', () => {
    ...
    const expected = Buffer.from(''
      + '000000000040000000000000000000000000000000000000000000000000000000020'
      + '000200000000000000000000000000000004000000000000000002000080000000000'
      + '0000100c0000000400000000000000000000000000000000020000000000000040000'
